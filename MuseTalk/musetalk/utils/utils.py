...
def load_all_model():
    ...
    audio_processor = Audio2Feature(model_path="/vol/whisper/tiny.pt")
    vae = VAE(model_path = "/vol/sd-vae-ft-mse/")
    unet = UNet(unet_config="/vol/musetalk/musetalk.json",
                model_path ="/vol/musetalk/pytorch_model.bin")
    pe = PositionalEncoding(d_model=384)
    total_time = time.time() - start_time
    print(f"Loading models time: {total_time} seconds")
